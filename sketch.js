...
function preload() {
  ...
  cannon_img = loadImage("canon.png");
  base_img = loadImage("cannonBase.png");
  boatSpriteData = loadJSON("boat.json");
  boatSpriteSheet = loadImage("boatAnimation.png");
  boat_crashesSpriteData = loadJSON("brokenBoat.json");
  boat_crashesSpriteSheet = loadImage("brokenBoat.png");
  cannonBallSplashData = loadJSON("waterSplash.json");
  cannonBallSplashSpriteSheet = loadImage("waterSplash.png");
}
